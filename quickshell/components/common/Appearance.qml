...
Singleton {
    id: root
    property QtObject batteryColor
    ...
    m3colors: QtObject {
        ...
        property color m3tertiary_paletteKeyColor: "#e7a54f"
        property color m3neutral_paletteKeyColor: "#ffdfc4"
        property color m3neutral_variant_paletteKeyColor: "#c2fcb0"
